...
import { Link } from 'react-router-dom'; // <--- IMPORTANTE: Usamos Link para navegación interna
import { 
    ...
    <div className="min-h-screen bg-slate-950 text-slate-200 font-sans selection:bg-orange-500/30 overflow-x-hidden pb-20 md:pb-0">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-14 items-center">
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              {/* LINKS ESTRATÉGICOS SEO */}
              <Link to="/sistema-de-turnos" className="text-sm font-medium hover:text-orange-500 transition">Cómo funciona</Link>
              <Link to="/ayuda" className="text-sm font-medium text-slate-400 hover:text-white transition">Ayuda</Link>
            ...
            <div className="md:hidden flex items-center gap-4">
              <Link to="/ayuda" className="text-slate-400"><HelpCircle size={20}/></Link>
      ...
      <header className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 text-center relative z-10">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-orange-500/10 border border-orange-500/30 text-xs font-bold text-orange-400 mb-8 shadow-lg shadow-orange-900/10">
          ...
          <h1 className="text-5xl md:text-7xl font-bold text-white tracking-tight mb-6 leading-[1.1]">
            El <span className="text-orange-500 text-notranslate">Sistema de turnos online</span> para <br />
          ...
          <p className="text-lg md:text-xl text-slate-400 max-w-2xl mx-auto mb-10 leading-relaxed">
            Optimice su negocio con profesionalismo. Centralice su agenda digital, órdenes de trabajo y comunicación automática con clientes en una plataforma SaaS líder en Argentina.
          </p>
          ...
          <div className="mt-20 relative max-w-6xl mx-auto flex flex-col md:flex-row justify-center items-center gap-8 md:gap-0">
                <img src={imgLogin} alt="Panel de control sistema de turnos online Argentina" className="w-64 md:w-72 md:-mr-12 md:mt-12 rounded-[2.5rem] border-[6px] border-slate-900 shadow-2xl z-10" />
                <div className="relative w-72 md:w-80 z-20 shadow-2xl">
                    <img src={imgMain} alt="Agenda digital para negocios TurnoMov" className="w-full h-auto rounded-[2.5rem] border-[6px] border-slate-800 shadow-2xl" />
                </div>
                <img src={imgProfile} alt="Gestión de clientes en plataforma de turnos" className="w-64 md:w-72 md:-ml-12 md:mt-12 rounded-[2.5rem] border-[6px] border-slate-900 shadow-2xl z-10" />
          </div>
        </div>
      </header>

      {/* --- BLOQUE SEO ACTUALIZADO CON ENLACES INTERNOS --- */}
      <section className="py-20 bg-slate-950 border-y border-slate-900">
        <div className="max-w-4xl mx-auto px-6">
          <h2 className="text-3xl font-bold text-white mb-6">Por qué elegir TurnoMov para digitalizar su comercio</h2>
          <div className="grid md:grid-cols-2 gap-8 text-slate-400 text-sm leading-relaxed">
            <p>
              En el mercado de <strong>Argentina y Latinoamérica</strong>, implementar un <Link to="/sistema-de-turnos" className="text-orange-500 font-bold hover:underline">sistema de turnos online</Link> es fundamental para mejorar la rentabilidad. TurnoMov permite que su <strong>agenda digital</strong> trabaje por usted las 24 horas, permitiendo reservas sin intervención manual.
            </p>
            <p>
              Nuestra plataforma está optimizada para servicios técnicos, centros de estética y consultorios. Si tiene dudas sobre cómo empezar, puede visitar nuestro <Link to="/ayuda" className="text-white underline font-medium">Centro de Ayuda</Link> donde encontrará tutoriales paso a paso para configurar su subdominio y recordatorios.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="precios" className="py-24 max-w-5xl mx-auto px-4 scroll-mt-24">
         <div className="bg-gradient-to-b from-slate-900 to-slate-950 rounded-[2.5rem] border border-slate-800 p-8 md:p-16 text-center relative overflow-hidden">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6 text-notranslate text-balance">Planes adaptados a su crecimiento</h2>
            <div className="grid md:grid-cols-3 gap-6 relative z-10">
                ...
                <div className="bg-slate-800 border-2 border-orange-500 p-8 rounded-3xl shadow-2xl transform md:-translate-y-4">
                    ...
                    <a href={whatsappLink} className="block w-full bg-orange-600 hover:bg-orange-500 text-white py-3 rounded-xl font-bold transition shadow-lg">Empezar Gratis</a>
                </div>
      ...
      <footer className="border-t border-slate-900 py-12 bg-slate-950 text-slate-500 text-sm">
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-12 items-start">
          <div className="space-y-4">
            ...
            <p>El sistema de turnos online más robusto para Argentina y Latinoamérica. Gestión profesional de agenda y clientes.</p>
          </div>
          <div className="grid grid-cols-2 gap-8">
            <div className="flex flex-col gap-3">
              <span className="font-bold text-slate-300 uppercase text-[10px] tracking-widest">Producto</span>
              <a href="#beneficios" className="hover:text-white transition">Funcionalidades</a>
              <Link to="/sistema-de-turnos" className="hover:text-white transition">Cómo funciona</Link>
              <a href="#precios" className="hover:text-white transition">Precios</a>
            </div>
            <div className="flex flex-col gap-3">
              <span className="font-bold text-slate-300 uppercase text-[10px] tracking-widest">Soporte</span>
              <Link to="/ayuda" className="text-orange-500 font-bold hover:text-orange-400 flex items-center gap-1">
          ...
          <div className="text-left md:text-right">
            ...
            <p className="mt-2 text-[11px] opacity-50">Santiago del Estero, Argentina.</p>
          </div>
        </div>
      </footer>
